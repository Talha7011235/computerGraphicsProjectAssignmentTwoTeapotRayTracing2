...
public:
    ...
    // Create a Vector Component to represent the Global Horizontal X Axis.
    float getGlobalHorizontalXAxis() const;

    // Create a Vector Component to represent the Global Vertical Y Axis.
    float getGlobalVerticalYAxis() const;

    // Create a Vector Component to represent the Global Depth Z Axis.
    float getGlobalDepthZAxis() const;
    ...
    float fresnelEquations(const Vector3&, const float&) const;
